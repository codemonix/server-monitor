...
import ServerMetricsPage from "./ServersMetricsPage.js";
...
// Mock Grid Component
vi.mock("../components/ServerMetricsGrid.js", () => ({
    default: ({ rows }) => (
...
describe('ServerMetricsPage', () => {
    ...
    beforeEach(() => {
        vi.clearAllMocks();
        vi.spyOn(metricsThunks, "fetchServerStats").mockReturnValue({ type: "mock/fetchStats" } as any);
        vi.spyOn(metricPointsThunks, "fetchMetricPoints").mockReturnValue({ type: "mock/fetchPoints" } as any);
    });
