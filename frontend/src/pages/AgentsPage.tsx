...
import AgentsGrid from "../components/AgentsGrid.js";
import AgentsActionBar from "../components/AgentsActionBar.js";
import { fetchServerStats } from "../redux/thunks/metricsThunks.js";
import { Tabs, Tab, Box, Paper } from "@mui/material";
import EnrollmentTokensGrid from "../components/EnrollmentTokensGrid.js";
import AddAgentDialog from "../components/AddAgentDialog.js";

export default function AgentsPage() {
    const dispatch = useAppDispatch();
    const { items: allAgents = [], hiddenAgentIds = [] } = useAppSelector((state) => state.metrics);
    const agents = allAgents.filter(agent => !hiddenAgentIds.includes(agent._id));

    const loading = useAppSelector((state) => state.metrics.status === "loading");
